...
h2. News
* Planning - Support for Liferay 6 and migration into Ext Plugin
* *15.10.10* - Support for Oracle WebLogic AS (without reload)
* *08.10.10* - Ant environment with Service Builder support (download "extlet-ant-sdk.zip":http://github.com/downloads/topolik/extlet/extlet-ant-sdk.zip and look into "Basic Project - Ant"::http://wiki.github.com/topolik/extlet/basic-project---ant)
